...
**Case Study – Capstone Project for the Google Data Analytics Professional Certificate**
...
Holberton School regularly organizes communication events to increase brand awareness and drive student enrollment. The primary objective of this study is to analyze the performance of historical events in order to optimize future communication strategies. 
...
* **Reliable :** The data comes directly from the school’s internal enterprise management software.
* **Original :** First-hand primary source for the events, and an official state repository for the holiday calendars.
...
* **Cited:** Sources (Holberton's internal tool and data.gouv.fr) are clearly identified and traceable.

### 2.4. Data Governance & Security
In strict compliance with GDPR and data governance best practices, the dataset contains no health-related or sensitive information. All Personally Identifiable Information (PII) such as participants' full names, email addresses, or phone numbers has been excluded or anonymized prior to analysis to guarantee user privacy.