=========================================================================
Question 3 : Which time slot (morning, afternoon, day) generates the highest conversion rate?
Table : holberton_events.events_clean
=========================================================================


SELECT Apres_midi_Matin_Journee, 
...
GROUP BY Apres_midi_Matin_Journee
